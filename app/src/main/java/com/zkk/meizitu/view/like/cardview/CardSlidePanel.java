package com.zkk.meizitu.view.like.cardview;
...
public class CardSlidePanel extends ViewGroup {
    ...
    private List<ContentBean> dataList; // 存储的数据链表
    ...
    private void orderViewStack() {
        synchronized (obj1) {
            ...
            if (newIndex < dataList.size()) {
                ContentBean dataItem = dataList.get(newIndex);
     ...
     */
    public void fillData(List<ContentBean> dataList) {
